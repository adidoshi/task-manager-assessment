...
export const mockAssignees: Assignee[] = [
  { id: "bruce", name: "Bruce Banner" },
  { id: "tony", name: "Tony Stark" },
  { id: "steve", name: "Steve Rogers" },
  { id: "thor", name: "Thor Odinson" },
];
